...
class XNATAddProjEditor(object):
    def __init__(self, viewer = None, browser = None, XNATCommunicator = None):
        ...
        #projError = qt.QLabel("<font color=\"red\">P Error</font>")
        ...
        #subjError = qt.QLabel("<font color=\"red\">s Error</font>")
        ...
        #exptError = qt.QLabel("<font color=\"red\">e Error</font>")
    ...
    def show(self):
        ...
        #self.addProjWindow.setWindowModality(2)
