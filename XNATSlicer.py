...
class XNATSlicer:
  def __init__(self, parent):
    parent.title = "XNATSlicer" # TODO make this more human readable by adding spaces
    parent.categories = ["Remote"]
    parent.dependencies = []
    parent.contributors = ["Sunil Kumar (WashU-St. Louis, Dan Marcus (WashU-St. Louis), Steve Pieper (Isomics)"] # replace with "Firstname Lastname (Org)"
    parent.helpText = """
...
class XNATSlicerWidget:
  ...
  def setup(self):
    ...
    self.reloadButton.name = "XNATSlicer Reload"
